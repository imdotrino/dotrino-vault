 ...
 * `/vault#vault=`): son caracteres menos dentro del QR, y ahí los caracteres se
 * pagan en módulos. La ruta larga es `vault.dotrino.com/vault`, y las que fueron
 * canónicas (`/devices`, `/dispositivos`) siguen respondiendo —son las que la
 * gente ya tiene guardadas—; `parseInvite` las lee todas.
 */
