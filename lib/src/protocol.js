...
export const SCOPE = Object.freeze({
  ...
  // RÉPLICA (docs/replicas.md): una bóveda que guarda el acta y los sobres de otra y los
  // SIRVE cuando la principal no está. No sella, no admite a nadie y no cambia permisos:
  // eso es D4 y no se toca. Lo único que puede es repartir lo que ya estaba sellado —y
  // que ni ella misma puede abrir—, así que lo peor que hace una réplica hostil es
  // entregar algo viejo, nunca algo falso.
  REPLICA: 'vault:replica'
})
