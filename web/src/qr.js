 ...
 * ecosistema (`qrcode-generator`, la misma que usa el vault y `dotrino-qrgenerator`).
 * Sin JS de terceros en runtime: dibuja los módulos como <rect> en un SVG,
 * negro sobre blanco con zona de silencio, así es escaneable con cualquier tema.
 */
