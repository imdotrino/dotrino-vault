...
const T = {
  es: {
    ...
    confirm_renounce: 'Este dispositivo dejará de firmar por ti. Podrás devolvérselo desde el Master. ¿Seguir?',
  ...
  en: {
    ...
    confirm_renounce: 'This device will stop signing for you. You can give it back from the Master. Continue?',
